...
<!--                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="sexo">Usuário VIPER(WS)</label>
                            <input type="text" class="form-control" name="usuarioViper" id="usuarioViper" value="<?php if (isset($pessoap["usuarioViper"])) {echo $pessoap["usuarioViper"];} ?>"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="sexo">Usuário MultiBR(WS)</label>
                            <input type="text" class="form-control" name="usuarioMultiBR" id="usuarioMultiBR" value="<?php if (isset($pessoap["usuarioMultiBR"])) {echo $pessoap["usuarioMultiBR"];} ?>"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="sexo">Senha MultiBR(WS)</label>
                            <input type="text" class="form-control" name="senhaMultiBR" id="senhaMultiBR" value="<?php if (isset($pessoap["senhaMultiBR"])) {echo $pessoap["senhaMultiBR"];} ?>"/>
                        </div>
                    </div>-->
                    <div class="col-md-6">
                        <div class="form-group">
