...
$sql = "select nivelpagina.*, pagina.nome as pagina, modulo.nome as modulo, pagina.link as pagina_link 
            ...
            where nivelpagina.codnivel = '{$_SESSION["codnivel"]}' and nivelpagina.codpagina = 67";
...
<html>
    <head>
        ...
        <title>South Sistemas | <?= $titulo ?></title>
        ...
        <link rel="stylesheet" href="/visao/recursos/css/jquery-ui.min.css">
        <link rel="stylesheet" href="/visao/recursos/css/sweet-alert.css">  
    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div id="tabs">
                        ...
                        <span style="float: right; color: grey;width: 100%;text-align: right;">@ South Negócios</span>                            
                    </div>
                </section><!-- /.content -->
            </div><!-- /.content-wrapper -->
        ...
        <!-- jQuery 2.1.4 -->
        <script type="text/javascript" src="/sistema/plugins/jQuery/jQuery-2.1.4.min.js"></script>
        <script type="text/javascript" src="http://code.jquery.com/ui/1.11.2/jquery-ui.min.js"></script>  
        <!-- Bootstrap 3.3.5 -->
        <script type="text/javascript" src="/sistema/bootstrap/js/bootstrap.min.js"></script>
        <!-- FastClick -->
        <script type="text/javascript" src="/sistema/plugins/fastclick/fastclick.min.js"></script>
        <!-- AdminLTE App -->
        <script type="text/javascript" src="/sistema/dist/js/app.min.js"></script>
        <!-- AdminLTE for demo purposes -->
        <script type="text/javascript" src="/sistema/dist/js/demo.js"></script>
