                ...
                <form id="fcoeficiente" name="fcoeficiente" method="post" onsubmit="return false;">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="valor" id="valor" title="Digite aqui o coeficiente do dia" value="<?php if(isset($coeficiente["valor"]) && $coeficiente["valor"] != NULL && $coeficiente["valor"] != ""){echo $coeficiente["valor"];}?>"/>
                        </div>
                    </div>                    
                </form>
            </div>
