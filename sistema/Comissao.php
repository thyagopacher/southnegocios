...
$sql = "select nivelpagina.*, pagina.nome as pagina, modulo.nome as modulo, pagina.link as pagina_link 
            ...
            where nivelpagina.codnivel = '{$_SESSION["codnivel"]}' and pagina.link = 'Comissao.php'";
...
<html>
    <head>
        ...
        <title>South Sistemas | Relatório de Comissão</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <!-- jQuery 2.1.4 -->
        <script src="/sistema/plugins/jQuery/jQuery-2.1.4.min.js"></script>
        <script src="http://code.jquery.com/ui/1.11.2/jquery-ui.min.js"></script>  
        
        <script src="../visao/recursos/js/jquery.form.min.js"></script>
        
        
        <script src="../visao/recursos/js/ajax/Comissao.js?<?=date("YmdHis")?>"></script>
        <script src="../visao/recursos/js/ajax/Conta.js"></script>        
        
        <!-- Bootstrap 3.3.5 -->
        <script src="/sistema/bootstrap/js/bootstrap.min.js"></script>
        <!-- FastClick -->
        <script src="/sistema/plugins/fastclick/fastclick.min.js"></script>
        <!-- AdminLTE App -->
        <script src="/sistema/dist/js/app.min.js"></script>
        <!-- AdminLTE for demo purposes -->
        <script src="/sistema/dist/js/demo.js"></script>
        <script src="../visao/recursos/js/jquery.maskMoney.min.js"></script>
