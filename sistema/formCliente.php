...
<?php if ($nivelp["inserir"] == 1 || $nivelp["atualizar"] == 1) { ?>
                        ...
                        <input type="button" name="submit" value="Próximo" onclick="location.reload()" class="btn btn-primary"/>
                        <?php
                    }
                    ...
                    <?php if (isset($_GET["codpessoa"])) { ?>
                        <span style="color: #337ab7; font-size: 12px;">***Salve para passar a ficha...</span>
                    <?php } ?>
                </div>                                        
            </div>
        </div>      
