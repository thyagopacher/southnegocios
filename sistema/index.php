...
$configuracaop = $conexao->comandoArray('select consultade from configuracao where codempresa = ' . $_SESSION["codempresa"]);
$sql = "select primeiroacesso from pessoa where codpessoa = {$_SESSION["codpessoa"]} and codempresa = {$_SESSION["codempresa"]}";
...
<html  manifest="site.appcache">
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="/sistema/plugins/iCheck/flat/blue.css">
        <!-- Morris chart -->
        <link rel="stylesheet" href="/sistema/plugins/morris/morris.css">
        <!-- jvectormap -->
        <link rel="stylesheet" href="/sistema/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
        <!-- Date Picker -->
        <link rel="stylesheet" href="/sistema/plugins/datepicker/datepicker3.css">
        <!-- Daterange picker -->
        <link rel="stylesheet" href="/sistema/plugins/daterangepicker/daterangepicker-bs3.css">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
					...
					and agenda.codpessoa not in(select codpessoa from atendimento where codempresa = agenda.codempresa and atendimento.dtcadastro >= '" . date('Y-m-d') . " 00:00:00'  and atendimento.dtcadastro <= '" . date('Y-m-d') . " 23:59:59')
                                ...
                                <a href="../sistema/Cliente.php?callcenter=true&agendamentos=true" class="small-box-footer">Mais informações <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            <!-- small box -->
...
if (!isset($roteiroEscrito) || $roteiroEscrito == NULL) {
    $reslink = $conexao->comando('select banco.nome, 
...
?>
        ...
        <script src="/visao/recursos/js/Geral.js?123456789" charset="utf-8"></script>
        ...
        <script src="/sistema/plugins/morris/morris.min.js"></script>
        <!-- Sparkline -->
        <script src="/sistema/plugins/sparkline/jquery.sparkline.min.js"></script>
        <!-- jvectormap -->
        ...
        <!-- jQuery Knob Chart -->
        <script src="/sistema/plugins/knob/jquery.knob.js"></script>
        <!-- daterangepicker -->
        <script src="/visao/recursos/js/moment.min.js"></script>
        <script src="/sistema/plugins/daterangepicker/daterangepicker.js"></script>
        <!-- datepicker -->
        <script src="/sistema/plugins/datepicker/bootstrap-datepicker.js"></script>
        <script src="/sistema/plugins/datepicker/locales/bootstrap-datepicker.pt-BR.js"></script>
        <!-- Bootstrap WYSIHTML5 -->
        <script src="/sistema/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
        <!-- Slimscroll -->
        <script src="/sistema/plugins/slimScroll/jquery.slimscroll.min.js"></script>
