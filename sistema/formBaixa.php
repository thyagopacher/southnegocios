            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                            <?php
                    if($nivelp["inserir"] == 1){
                        echo '<input type="button" name="submit" value="Cadastrar" id="btinserirBaixa" onclick="inserir();" class="btn btn-primary"/>';
                    }            
                    if($nivelp["atualizar"] == 1){
                        echo '<input style="margin-left: 5px; display: none" type="button" name="submit" id="btatualizarBaixa" value="Atualizar" onclick="atualizar();" class="btn btn-primary"/>';
                    }
                    if($nivelp["excluir"] == 1){
