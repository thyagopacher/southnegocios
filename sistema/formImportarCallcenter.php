        ...
        <div class="box-body">
            <div class="row">
                <form id="fimportacao" name="fimportacao" method="post" action="../control/Importacao.php">
                    ...
                    <!--<div class="col-md-12">
                        <div class="form-group">
                            <input type="checkbox" name="somente_telefone" id="somente_telefone" value="s" /><label style="font-size: 12px; color: #666;">  Atualizar somente telefones!</label>
                        </div>
                    </div> -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="/arquivos/layout_de_importacao_29_06_2015.xls" target="_blank"> 
                                    <img src="../visao/recursos/img/download.png" style="width: 35px; height: 35px; margin-left: 100px;"><label style="font-size: 12px; color: #666;">Download planilha padrão</label></a>                                 
                            </div>   
                        </div> 
                    </div>                    
                </form>
            ...
            <div class="row">
<!--                * Tabela deve estar no formato .xls<br>
                * Data de alteração formato dd/mm/YYYY<br>
                <a href="/arquivos/layout_de_importacao_29_06_2015.xls" target="_blank"><img src="../visao/recursos/img/download.png" style="width: 30px;"/>Download planilha padrão</a>                
                <div class="progress">
                    <div class="bar"></div>
                    <div class="percent">0%</div>
                </div>
