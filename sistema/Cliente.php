...
<html lang="pt-br">
    <head>  
        <title>South Sistemas | <?= strip_tags($titulo) ?></title>
        <link rel="stylesheet" type="text/css" href="/visao/recursos/css/detalhamento.css?123456">  
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <script type="text/javascript" src="http://southnegocios.com.br/visao/recursos/js/ajax/Pessoa.js"></script>
