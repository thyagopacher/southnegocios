            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type='text' class="form-control" name="telefone" id="telefone" placeholder="Digite telefone fixo" value='<?php if (isset($empresaf["telefone"])) {
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type='text' class="form-control" name="celular" id="celular" placeholder="Digite celular" value='<?php if (isset($empresaf["celular"])) {
