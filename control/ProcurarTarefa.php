<?php
    ...
    if($qtd > 0){
        ...
        while($tarefa = $conexao->resultadoArray($res)){
            ...
            echo '<a href="#" onclick="excluir2Tarefa(',$tarefa["codtarefa"],')" title="Clique aqui para excluir o tarefa"><img src="../visao/recursos/img/excluir.png" alt="botão excluir"/></a>';
            echo '</td>';
            echo '</tr>';
        }
        echo '</tbody>';
