<?php
    ...
    if($qtd > 0){
        ...
        while($documento = $conexao->resultadoArray($res)){
            ...
            echo '<a href="#" onclick="excluir2Documento(',$documento["coddocumento"],')" title="Clique aqui para excluir"><img src="../visao/recursos/img/excluir.png" alt="botão excluir"/></a>';
            echo '</td>';
            echo '</tr>';
        }
        echo '</tbody>';
