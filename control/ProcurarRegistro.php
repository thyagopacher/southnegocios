...
//            echo 'Tipo:',$registro["tipo"], '<br>';
            ...
            echo '<a href="#" onclick="excluir2Registro(',$registro["codregistro"],')" title="Clique aqui para excluir"><img style="width: 20px;" src="../visao/recursos/img/excluir.png" alt="botão excluir"/></a>';
            echo '</td>';
            echo '</tr>';
            $titulo = "";
        }
