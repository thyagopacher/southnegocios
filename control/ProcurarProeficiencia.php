<?php
    ...
    if($qtd > 0){
        ...
        while($proeficiencia = $conexao->resultadoArray($res)){
            ...
            echo '<a href="#" onclick="excluir2Proeficiencia(',$proeficiencia2["codproeficiencia"],')" title="Clique aqui para excluir"><img src="../visao/recursos/img/excluir.png" alt="botão excluir"/></a>';
            echo '</td>';
            echo '</tr>';
        }
        echo '</tbody>';
