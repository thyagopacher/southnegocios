...
if (isset($_SESSION["codnivel"]) && $_SESSION["codnivel"] == "16" && !isset($_POST['codcliente'])) {
                            ...
                            while ($proposta = $conexao->resultadoArray($res)) {
                                ...
                                <tr role="row" class="<?= $classe_linha ?>">
                                    ...
                                    <?php if (isset($_POST["codcliente"])) { ?>
                                        <td>
                                            <?php
$arrayJavascript = "new Array('{$proposta["codproposta"]}', '{$proposta["codbanco"]}', '{$proposta["codconvenio"]}', '{$proposta["codtabela"]}', '{$proposta["prazo"]}', '" . number_format($proposta["vlsolicitado"], 2, ",", "") . "', '" . number_format($proposta["vlparcela"], 2, ",", "") . "', 
'" . number_format($proposta["vlliberado"], 2, ",", "") . "', '{$proposta["codbeneficio"]}', '{$comissoes["peso"]}', '{$proposta["codbanco2"]}', '{$proposta["agencia"]}', '{$proposta["conta"]}', '{$proposta["operacao"]}', '{$proposta["poupanca"]}', 
'{$proposta["dtvenda"]}', '{$proposta["codfuncionario"]}', '{$observacao["observacao"]}', '{$proposta["codstatus"]}', '{$proposta["pendente"]}', '{$proposta["dtpago"]}', '{$proposta["beneficio"]}', '{$proposta["codespecie"]}', '{$proposta["corrente"]}')";
                                            
                                            echo '<a href="javascript: setaProposta(', $arrayJavascript, ')" title="Clique aqui para editar"><img style="width: 25px;" src="../visao/recursos/img/editar.png" alt="botão editar"/></a>';
