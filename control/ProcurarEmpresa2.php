                            ...
                            <tbody>
                                ...
                                <tr role="row" class="<?= $classe_linha ?>">
                                    ...
                                    <td>
                                        ...
                                        echo '<a href="#" onclick="excluir2Empresa(', $empresa["codempresa"], ')" title="Clique aqui para excluir"><img style="width: 20px;" src="../visao/recursos/img/excluir.png" alt="botão excluir"/></a>';
                                        ?>
                                    </td>
                                </tr>
                                <?php }?>
