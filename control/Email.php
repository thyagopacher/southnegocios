...
class Email {
    ...
    /*     * phpmailer */
    public $host = "mx2.weblink.com.br";
...
//        echo "<br>-- Envio de E-mail por--<br>";
//        echo "Host: {$this->mail->Host}<br>";
//        echo "Username: {$this->mail->Username}<br>";
//        echo "Password: {$this->mail->Password}<br>";
//        echo "Port: {$this->mail->Port}<br>";
//        echo "Para: {$this->para_email}<br>";
//        echo "Assunto: {$this->assunto}<br>";
//        echo "Mensagem: {$this->mensagem}<br>";
//        echo "Segurança: {$this->seguranca}<br>";
//        echo "Autenticação: {$this->autenticacao}<br>";
