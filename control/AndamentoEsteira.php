...
if (isset($_SESSION["codnivel"]) && $_SESSION["codnivel"] != '1' && $_SESSION["codnivel"] != "19"  && $_SESSION["codnivel"] != "24") {
...
$sql = "select proposta.*, 
    ...
    where 1 = 1 {$and} order by statusprioritario desc,proposta.dtcadastro desc";  
            ...
            while ($proposta = $conexao->resultadoArray($resproposta)) {
                ...
                <tr>
                    ...
                    <td class="<?= $proposta["cor"] ?>">
                        ...
                        <a href="javascript: excluir2Proposta('<?= $proposta["codproposta"] ?>')"><img src="/visao/recursos/img/excluir.png" alt="Excluir Proposta"/></a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
