<?php
    ...
    if($qtd > 0){
        ...
        while($arquivo = $conexao->resultadoArray($res)){
            ...
            echo '<td>';
            echo '<a href="#" onclick="excluir2ArquivoPessoa(',$arquivo["codarquivo"],')" title="Clique aqui para excluir o arquivo"><img src="../visao/recursos/img/excluir.png" alt="botão excluir"/></a>';
            echo '</td>';
            echo '</tr>';
        }
        echo '</tbody>';
