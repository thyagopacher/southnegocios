...
if (!isset($_SESSION["nome"])) {
    ...
    $titulo = "Carteiras Liberadas aos Atendentes";
    $nivelp = $conexao->comandoArray("select * from nivelpagina where codnivel = '{$_SESSION["codnivel"]}' and nivelpagina.codpagina = 67");
}
?>
<!DOCTYPE html>
<html lang="pt-br">
