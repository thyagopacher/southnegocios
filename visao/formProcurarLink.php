<form id="fplink" action="../control/ProcurarLinkRelatorio.php" target="_blank" role="form" class="form-horizontal form-groups-bordered" method="POST" onsubmit="return false;">                       
    ...
    <button onclick="procurarLink(false)">Procurar</button>
    <?php
//    if(isset($nivelp["gerapdf"]) && $nivelp["gerapdf"] == 1){
//        echo '<button onclick="abreRelatorioLink()">Gera PDF</button> ';
//    }
//    if(isset($nivelp["geraexcel"]) && $nivelp["geraexcel"] == 1){
//        echo '<button onclick="abreRelatorio2Link()">Gera Excel</button>';
//    }
    ?>
</form>
<?php include("./carregando.php");?>
<div id="listagemLink"></div>
