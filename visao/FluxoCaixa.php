...
if (!isset($_SESSION["nome"])) {
    ...
    $conexao = new Conexao();    
    $nivelp = $conexao->comandoArray("select * from nivelpagina where codnivel = '{$_SESSION["codnivel"]}' and codpagina = '8'");
}
?>
<!DOCTYPE html>
...
<html lang="pt-br">
    <head>
        ...
        <title>South Negócios › Fluxo de Caixa</title>               
    </head>
    <body>
        <?php 
...
<script type="text/javascript" src="/visao/recursos/js/jquery-1.10.2.min.js"></script>
        ...
        <script src="./recursos/js/ajax/FluxoCaixa.js"></script>
