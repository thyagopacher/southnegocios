                    ...
                    <div class="conteudo"> 
                        <form method="post" id="login-superior" action="../control/Login.php">
                            <div id="lado-a-login-superior">
                                <input type="text" name='email' placeholder="Digite Seu E-mail" class="input-login-superior input-a-login-superior"/>
                                <label class="label-login-superior"><input type='password' name='senha' placeholder="Digite Sua Senha" class="input-login-superior input-b-login-superior"/>
                                    <a href="" title="">esqueçeu sua senha ?</a>
                                </label>
            ...
            <div id="inferior">  
                <div class="central"> 
                    <div class="conteudo"> 
                        ...
                        <div id="direitos">  
                            <h2 id="h2-direitos">Copyright © 2012 - <?=date("Y");?> - Todos os direitos reservados - <span class="span-bold">SIS</span></h2> h2-direitos 
                        </div>  
                    </div> 
                </div> 
            </div>  
