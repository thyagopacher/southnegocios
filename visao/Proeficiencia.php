...
if(isset($_SESSION["nome"])){
    ...
    $conexao = new Conexao();
    if (isset($_GET["perfil"]) && $_GET["perfil"] != NULL && $_GET["perfil"] != "") {
        ...
        $titulo = "Alterar proeficiencias";
    } else {
        $titulo = "Cadastrar proeficiencias";
    }
    $sql = "select * from nivelpagina where codnivel = '{$_SESSION["codnivel"]}' and codpagina = '91'";
...
<html lang="pt-br">
    ...
    <body>
        ...
        <script src="./recursos/js/ajax/Proeficiencia.js"></script>
