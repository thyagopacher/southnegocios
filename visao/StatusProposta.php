...
if (!isset($_SESSION["nome"])) {
    ...
    $nivelp = $conexao->comandoArray("select * from nivelpagina where codnivel = '{$_SESSION["codnivel"]}' and codpagina = '84'");
}
?>
<!DOCTYPE html>
    ...
    <body>
        ...
        <h3><?= $titulo ?></h3>
         <div id="tabs" style="width: 955px; margin: 0 auto;  margin-top: 55px;">
            ...
            <div id="tabs-2">
                <?php 
                    include("formProcurarStatusProposta.php");
                ?>
            </div>
            <?php }?>
        </div>
...
<script type="text/javascript" src="/visao/recursos/js/jquery-1.10.2.min.js"></script>
        ...
        <script type="text/javascript" src="./recursos/js/ajax/StatusProposta.js"></script>
