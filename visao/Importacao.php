...
<html lang="pt-br">
    <head>
        ...
        <title>South Negócios › Importação Clientes</title>
    </head>
    <body>
        <?php
            ...
            <div id="tabs-1">
                <form name="fimportacao" autocomplete="off" id="fimportacao" method="post" action="../control/Importacao.php">
                    <table class="tabela_formulario">
                        <tr>
                            <td title="digite aqui ou escolha nome de carteira de clientes">Nome</td>
                            <td colspan="3">
                                ...
                                <?php
                                    ...
                                    if($qtdnomes > 0){
                                        while($nome = $conexao->resultadoArray($resnomes)){
                                            echo '<option value="',$nome["codcarteira"],'">',$nome["nome"],'</option>';
                                        }
                                    }
                                ?>                                    
                                </datalist>
