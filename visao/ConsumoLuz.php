...
if (!isset($_SESSION["nome"])) {
    ...
    if (isset($codigo)) {
        include("../model/ConsumoLuz.php");
        $consumo = $conexao->comandoArray("select consumoluz.*
        from consumoluz 
    ...
    <body>
        ...
        <h3><?= $titulo ?></h3>
         <div id="tabs" style="width: 955px; margin: 0 auto;  margin-top: 55px;">
            ...
            <div id="tabs-1">
                <?php include("formConsumoLuz.php");?>
            </div>
            <div id="tabs-2">
                <?php 
                if(isset($nivelp) && isset($nivelp["procurar"]) && $nivelp["procurar"] == 1){
                    include("formProcurarConsumoLuz.php");
                }
                ?>
            </div>
            <div id="tabs-3">
        ...
        <script src="./recursos/js/ajax/ConsumoLuz.js"></script>
