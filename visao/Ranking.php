...
if(isset($_SESSION["nome"])){
    ...
    $conexao = new Conexao();
    $nivelp = $conexao->comandoArray("select * from nivelpagina where codnivel = '{$_SESSION["codnivel"]}' and codpagina = '81'");
}
?>
<!DOCTYPE html>
<html lang="pt-br">
    ...
    <body>
        ...
        <script type="text/javascript" src="./recursos/js/ajax/Ranking.js"></script>
