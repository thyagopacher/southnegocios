...
if(isset($_SESSION["nome"]) && $_SESSION["nome"] != NULL && $_SESSION["nome"] != ""){
    ...
    $conexao = new Conexao();
    $nivelp = $conexao->comandoArray("select * from nivelpagina where codnivel = '{$_SESSION["codnivel"]}' and codpagina = '51'");
}
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <title>South Negócios › Chat Master</title>
    </head>
    <body>
        <?php
